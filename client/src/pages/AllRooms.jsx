...
const RationButton = ({label, selected = false, onChange= () => {}}) => {
    return (
        <label className='flex gap-3 items-center cursor-pointer mt-2 text-sm'>
...
const AllRooms = () => {
  ...
  return (
            ...
            {roomsDummyData.map((room)=>(
                <div key={room._id} className= 'flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:border-0'>
                    ...
                    <div className='md:1/2 flex flex-col gap-2'>
                        ...
                        <div className='flex items-cent gap-1 text-gray-500 mt-2 text-sm'>
    ...
    {/* Filters */}
    <div className='bg-white w-80 border border-gray-300 text-gray-600 maz-lg:mb-8 min-lg:mt-16'>
        ...
        <div className='px-5 pt-5'>
         ...
         <div className='px-5 pt-5 pb-7'>
            ...
            {sortOptions.map((option, index)=>(
                <RationButton key={index} label={option}/>              
            ))}
        </div>
