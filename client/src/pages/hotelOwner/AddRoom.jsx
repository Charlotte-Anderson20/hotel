...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title align='left' font='outfit' title='Add Room' subTitle='Carefully enter all necessary information—room specifications, pricing, and included amenities—to create a clear and appealing listing for potential guests.'/>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
          ...
          <div>
             <p className='mt-4 text-gray-800'>
                Price <span className='texxt-xs'>/night</span>
             </p>
